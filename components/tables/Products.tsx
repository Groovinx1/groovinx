...
import DesignDetails from '../modals/DesignDetails'
                            ...
                            {data?.map((item, i) => {
                                return (
                                    <tr key={i} className="">
                                        ...
                                        <td className=""> <div className="flex justify-center items-center cursor-pointer"><button className="bg-primary-50 p-1 rounded-md px-3 hover:bg-primary hover:text-white" onClick={() => openModal()}>View more</button> {parse(Icons.more)}</div> </td>
                                    </tr>
                                )
                            })}
                        </tbody>

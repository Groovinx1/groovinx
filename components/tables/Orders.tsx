                            ...
                            {data?.map((item, i) => {
                                return (
                                    <tr key={i} className="">
                                        ...
                                        <td>{item.amount}</td>
                                        <td className="text-sm"> <div className="w-full cursor-pointer "><button className="bg-primary text-white p-1 rounded-md lg:w-4/5 hover:opacity-50" onClick={() => openModal()}>View more</button></div> </td>
                                    </tr>
                                )
                            })}
                        </tbody>

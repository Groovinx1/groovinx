        ...
        <div className="flex gap-5 text-sm items-center cursor-pointer">
          ...
          <div className="bg-gray-50 w-1/2 flex items-center px-3 gap-2">
            ...
            <input
              ...
              name=""
              id=""
              className="py-3 bg-gray-50 w-full text-dark focus:outline-none"
              placeholder="Search Orders by Date or Category"
            />
          </div>
        </div>
      </div>
                  ...
                  <tr key={i} className="">
                    ...
                    <td>
                      ...
                      <span className="block text-xs">
                        {item.customer_login_status}
                      </span>
                    </td>
                    <td className="text-justify">
                      <span className="block">{item.designer}</span>
                      <span className="block text-xs ">
                        {item.designer_login_status}
                      </span>
                    </td>
                    <td className="text-justify">
                      {item.status.toLowerCase() === "completed" ? (
                        <div className=" my-1 lg:w-1/3 text-center">
                          <span className="text-green-500 bg-green-100  py-1 px-2 rounded-full m-auto font-bold text-xs flex gap-1 items-center">
                            {" "}
                            <span className="ellipse bg-green-600 rounded-full"></span>{" "}
                            {item.status}
                          </span>
                        </div>
                      ) : (
                        <div className=" my-1 lg:w-1/3 text-center">
                          <span className="text-red-500 bg-red-100  py-1 px-2 rounded-full m-auto font-bold text-xs flex gap-1 items-center">
                            {" "}
                            <span className="ellipse bg-red-600 rounded-full"></span>{" "}
                            {item.status}
                          </span>
                        </div>
                      )}
                    ...
                    <td className="text-sm">
                      ...
                      <div className="w-full cursor-pointer ">
                        <button
                          className="bg-primary text-white p-1 rounded-md lg:w-4/5 hover:opacity-50"
                          onClick={() => openModal()}
                        >
                          View more
                        </button>
            ...
            <div className="w-full flex gap-20 text-xs items-center">
              <div className="flex items-center">
                ...
                <select
                  name=""
                  id=""
                  className="bg-primary-50 focus:outline-none p-3"
                >

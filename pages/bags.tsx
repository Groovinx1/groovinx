  ...
  return (
    <Dashboard navTitle={"Bags"} navSubTitle={"Statistics"}>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-10 p-5 lg:p-0">
        <Card
          total="7k Full Design"
          title="In Total"
          img={"./cube.png"}
          bgColor="bg-green-400"
        />
        <Card
          total="15.2k Single Pattern  "
          title="In Total"
          img={"./cube.png"}
          bgColor="bg-primary"
        />
        ...
        <div className="relative top-10 p-5 lg:p-0">
          ...
          <div className="flex gap-5 overflow-auto">
            ...
            <h1
              ...
              onClick={() => setActiveTab("hand_bag")}
            >
              Hand Bag
            </h1>
            <h1
              className="text-sm pl-4 hover:text-primary cursor-pointer"
              onClick={() => setActiveTab("back_pack")}
            >
              Back Pack
            </h1>
            <h1
            ...
            <h1
              className="text-sm pl-4 hover:text-primary cursor-pointer"
              onClick={() => setActiveTab("travel_bag")}
            >
              Travel Bag
            </h1>
          </div>
            ...
            <div
              className={
                activeTab === "all"
                  ...
                  : activeTab === "travel_bag"
                  ? "p-0.5 bg-primary w-12 ml-85"
                  : ""
              }
            ></div>

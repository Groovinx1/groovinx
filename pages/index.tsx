  ...
  return (
    <Dashboard navTitle={"Users"} navSubTitle={"Statistics"}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-10 mb-5 p-5 lg:p-0">
        <Card total="+1200" title="Users" img={'./cube.png'} bgColor="bg-primary" />
        <Card total="200" title="Designs" img={'./cube.png'} bgColor="bg-primary" />
        <Card total="+1200" title="7K Total Users" img={'./cube.png'} bgColor="bg-green-400" />
      </div>
        ...
        <div className="w-full text-sm">
          <div className="float-right lg:w-1/2">
            <div className="float-right flex gap-5 mr-5">
              <Link href="/messages"><a className="bg-primary text-center text-white py-2 px-10 rounded hover:opacity-50">Message inbox</a></Link>
              <button className="bg-primary text-center text-white py-2 px-10 rounded hover:opacity-50"  onClick={() => openModal()}>Add +</button>
            </div>
          </div>
        </div>
        {/* table of users */}

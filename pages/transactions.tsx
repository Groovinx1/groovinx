    ...
    return (
        <Dashboard navTitle={"Transactions"} navSubTitle={"Statistics"}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-10 p-5 lg:p-0">
                <Card total="$157k Revenue" title="This Month" img={'./cube.png'} bgColor="bg-green-400" />
                <Card total="234 Sales" title="Orders this Month" img={'./cube.png'} bgColor="bg-primary" />
                <Card total="$700k Total Revenue" title="In Total" img={'./cube.png'} bgColor="bg-green-400" />
            </div>
